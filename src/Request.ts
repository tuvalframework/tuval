    export class Request {
        ...
        public getSize(): number {
            return Buffer.byteLength(Object.values(this.generateHeaders()).join("\n"), 'utf8') + Buffer.byteLength(this.rawPayload, 'utf8');
        }
        ...
        protected generateInput(): Record<string, any> {
            if (this.queryString === null) {
                this.queryString = (global as any)._GET;
            }
            if (this.payload === null) {
                ...
                this.rawPayload = (global as any)._RAW_PAYLOAD;
                ...
                switch (contentType) {
                    case 'application/json':
                        ...
                        break;
                    default:
                        this.payload = (global as any)._POST;
                        break;
                }
