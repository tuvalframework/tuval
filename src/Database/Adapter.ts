...
export abstract class Adapter {
    ...
    public abstract create(name: string): boolean;
    public abstract exists(database: string, collection?: string): boolean;
    public abstract list(): Array<any>;
    public abstract delete(name: string): boolean;
    public abstract createCollection(name: string, attributes?: Array<any>, indexes?: Array<any>): boolean;
    public abstract deleteCollection(id: string): boolean;
    public abstract createAttribute(collection: string, id: string, type: string, size: number, signed?: boolean, array?: boolean): boolean;
    public abstract updateAttribute(collection: string, id: string, type: string, size: number, signed?: boolean, array?: boolean, newKey?: string): boolean;
    public abstract deleteAttribute(collection: string, id: string): boolean;
    public abstract renameAttribute(collection: string, oldId: string, newId: string): boolean;
    public abstract createRelationship(collection: string, relatedCollection: string, type: string, twoWay?: boolean, id?: string, twoWayKey?: string): boolean;
    public abstract updateRelationship(collection: string, relatedCollection: string, type: string, twoWay: boolean, key: string, twoWayKey: string, side: string, newKey?: string, newTwoWayKey?: string): boolean;
    public abstract deleteRelationship(collection: string, relatedCollection: string, type: string, twoWay: boolean, key: string, twoWayKey: string, side: string): boolean;
    public abstract renameIndex(collection: string, old: string, newId: string): boolean;
    public abstract createIndex(collection: string, id: string, type: string, attributes: Array<string>, lengths: Array<number>, orders: Array<string>): boolean;
    public abstract deleteIndex(collection: string, id: string): boolean;
    public abstract getDocument(collection: string, id: string, queries?: Array<any>, forUpdate?: boolean): any;
    public abstract createDocument(collection: string, document: any): any;
    public abstract createDocuments(collection: string, documents: Array<any>, batchSize: number): Array<any>;
    public abstract updateDocument(collection: string, document: any): any;
    public abstract updateDocuments(collection: string, documents: Array<any>, batchSize: number): Array<any>;
    public abstract deleteDocument(collection: string, id: string): boolean;
    public abstract find(collection: string, queries?: Array<any>, limit?: number, offset?: number, orderAttributes?: Array<string>, orderTypes?: Array<string>, cursor?: Record<string, any>, cursorDirection?: string): Array<any>;
    public abstract sum(collection: string, attribute: string, queries?: Array<any>, max?: number): number;
    public abstract count(collection: string, queries?: Array<any>, max?: number): number;
    public abstract getSizeOfCollection(collection: string): number;
    ...
    public abstract getSupportForFulltextWildcardIndex(): boolean;
    public abstract getSupportForCasting(): boolean;
    public abstract getSupportForQueryContains(): boolean;
    public abstract getSupportForTimeouts(): boolean;
    ...
    public abstract increaseDocumentAttribute(collection: string, id: string, attribute: string, value: number, updatedAt: string, min?: number, max?: number): boolean;
